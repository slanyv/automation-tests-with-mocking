...
public class HttpHeadersConstants {
    ...
    private static final Set<HttpHeader> DEFAULT_OPTION_HEADERS = new HashSet<HttpHeader>(DEFAULT_HEADERS) {
        {
            add(OPTION_CACHE_HEADER);
        }
    };

    private static final Set<HttpHeader> DEFAULT_NOT_OPTION_HEADERS = new HashSet<HttpHeader>(DEFAULT_HEADERS) {
        {
    ...
    private static final Set<HttpHeader> GET_HEADERS = new HashSet<HttpHeader>(DEFAULT_OPTION_HEADERS) {
        {
            add(ACCESS_REQUEST_GET_HEADER);
            add(ACCESS_CONTROL_ALLOW_METHODS_GET_HEADER);
        }
    ...
    private static final Set<HttpHeader> POST_HEADERS = new HashSet<HttpHeader>(DEFAULT_OPTION_HEADERS) {
        {
    ...
    private static final Set<HttpHeader> DELETE_HEADERS = new HashSet<HttpHeader>(DEFAULT_OPTION_HEADERS) {
        {
            add(ACCESS_REQUEST_GET_HEADER);
    ...
    public static final HttpHeaders HEADERS = new HttpHeaders(DEFAULT_NOT_OPTION_HEADERS);
